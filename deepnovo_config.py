...
input_file_train = "data/peaks.db.mgf.train.dup.100.train.dup"
input_file_valid = "data/peaks.db.mgf.train.dup.100.valid.dup"
input_file_test = "data/peaks.db.mgf.train.dup.100.test.dup"
...
output_file = 'train' + "/output.deepnovo_db.tab"
